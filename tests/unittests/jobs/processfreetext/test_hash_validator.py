...
class HashTestcase(unittest.TestCase):
    ...
    def test_validate_composite_md5_hash(self):
        testcases = ["file.txt|5d41402abc4b2a76b9719d911017c592",
        ...
        attribute_type: AttributeType = AttributeType(types=HashTypeValidator.hex_hash_types[32].composite,
    ...
    def test_validate_composite_sha1_hash(self):
        testcases = ["file.txt|2ef7bde608ce5404e97d5f042f95f89f1c232871",
                     "file.txt|6f594f1932be3e3cc02b5a7d5c333d671e9a4f1d",
                     "file.txt|271c91dc4b0fe1ce54176f07bc029c8b68854fc6"]
        attribute_type: AttributeType = AttributeType(types=HashTypeValidator.hex_hash_types[40].composite,
    ...
    def test_validate_composite_sha224_hash(self):
        testcases = ["file.txt|a5d8a06bccd1c763f8e8f3081cf354b06050c89e46a2c4c97a21de7c",
        ...
        attribute_type: AttributeType = AttributeType(types=HashTypeValidator.hex_hash_types[56].composite,
    ...
    def test_validate_composite_sha256_hash(self):
        testcases = ["file.txt|a69c5d1f84205a46570bf12c7bf554d978c1d73f4cb2a08b3b8c7f5097dbb0bd",
        ...
        attribute_type: AttributeType = AttributeType(types=HashTypeValidator.hex_hash_types[64].composite,
    ...
    def test_validate_composite_sha384_hash(self):
        ...
        attribute_type: AttributeType = AttributeType(types=HashTypeValidator.hex_hash_types[96].composite,
    ...
    def test_validate_composite_sha512_hash(self):
        ...
        attribute_type: AttributeType = AttributeType(types=HashTypeValidator.hex_hash_types[128].composite,
    ...
    def test_validate_generated_composite_hashes(self):
        def validate_hash(generated_hash):
            ...
            hash_types: HashTypeValidator.HashTypes = HashTypeValidator.hex_hash_types[
                len(generated_hash.hexdigest())].composite
            self.assertEqual(result, AttributeType(types=hash_types, default_type=hash_types[0],

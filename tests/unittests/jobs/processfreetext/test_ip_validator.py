...
class IPTestcase(unittest.TestCase):
    def test_validate_ipv4(self):
        ...
        attribute_type = AttributeType(types=['ip-dst', 'ip-src', 'ip-src/ip-dst'], default_type='ip-dst',
                                       value="")
    ...
    def test_validate_ipv6(self):
        testcases = ['2001:0db8:85a3:0000:0000:8a2e:0370:7334', "fe80::1%eth0", '2a00:1450:4007:816::200e',
    ...
    def test_validate_ipv4_port(self):
        ...
        attribute_type = AttributeType(types=['ip-dst|port', 'ip-src|port', 'ip-src|port/ip-dst|port'],
    ...
    def test_validate_ipv6_port(self):
        testcases = ['[2607:f8b0:4005:080a:0000:0000:0000:200e]:8080',

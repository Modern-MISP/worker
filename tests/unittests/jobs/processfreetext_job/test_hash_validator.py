...
class HashTestcase(unittest.TestCase):
    ...
    def test_validate_hashes(self):
        ...
        test_dictionary = [
            ...
            {'from': 'invalid56charstringABCDEF1234567890abcdef1234567890abcdef1234', 'to': None},  # not a valid sha224 hash
            {'from': 'invalid64charstringABCDEF1234567890abcdef1234567890abcdef1234567890abcd', 'to': None},  # not a valid sha256 hash
            {'from': 'invalid96charstringABCDEF1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd', 'to': None},  # not a valid sha384 hash
            {'from': 'invalid128charstringABCDEF1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd', 'to': None},  # not a valid sha512 hash
            ...
            {'from': 'a5d8a06bccd1c763f8e8f3081cf354b06050c89e46a2c4c97a21de7c', 'to': HashTypeValidator.hex_hash_types[56]},# sha224
            {'from': 'e7d4878fd75cb9eb7b2e77aa7db8f811007b1c75c7791b4f29b64b3a', 'to': HashTypeValidator.hex_hash_types[56]},# sha224
            {'from': 'c0c3e1f591f37284da784986f6d79656e388d9f5d5367b0bb773739d', 'to': HashTypeValidator.hex_hash_types[56]},# sha224
            {'from': 'a69c5d1f84205a46570bf12c7bf554d978c1d73f4cb2a08b3b8c7f5097dbb0bd', 'to': HashTypeValidator.hex_hash_types[64]}, # sha256
            {'from': 'e0d29e7a51d75c7b23a3ed84a3a6c7a91b31e1139c57ed3511d2684508f6892a', 'to': HashTypeValidator.hex_hash_types[64]}, # sha256
            {'from': 'c6b2f91678e24964b32e6bdf2e0c8a78ba8f4f76c6f51a1d1b61b60c06df32cd', 'to': HashTypeValidator.hex_hash_types[64]}, # sha256
            {'from': 'a582d7efc849450c78934d3a89a12b546d7e83eb7a4c336b3d8f4a4807ec2b0ba89e76d20b9206f9926922bb99773a57', 'to': HashTypeValidator.hex_hash_types[96]}, #sha384
            {'from': '9bc17d0b66a418f6780d58545033f9944f4e759256d20e70b18b99a43ce67b19141d13c653c52b079c9f88a4efc0389a', 'to': HashTypeValidator.hex_hash_types[96]}, #sha384
            {'from': 'ca0c8fb10e8b1509cb579e46a51e15a1efbd437a869ee29d2df5c3a710cd552e7745257ec349a9f4bd40f5fe6757426d', 'to': HashTypeValidator.hex_hash_types[96]}, #sha384
            {'from': '3e340f4d94f63919a222a535946ce53f30bc9fdd39fc145c22a64364c82bbf7ce8e2d8c9b67824e93be2a877eaf759cfc1569a48097af7c3eafe740e95a68f68', 'to': HashTypeValidator.hex_hash_types[128]}, #sha512
            {'from': 'e87fc03c8f9b038f51aa6749ff0ea1f155032f6e80d8438a427ac2d4ba773328fc322d2eaaec58e05ad0dd87011f04fb9e0a0c7e276e7082b3d651618b90c51b', 'to': HashTypeValidator.hex_hash_types[128]}, #sha512
            {'from': 'b10b29bf89919116e796f09780cf0750039ff14958e1593bf1a08c7ab83338c78b0562b6bcdf1047bdf5f9d18a156c448ba35cf38e9ef833bc0ff8ad6718f371', 'to': HashTypeValidator.hex_hash_types[128]} #sha512
        ]
        for testcase in test_dictionary:
    ...
    def test_validate_composite_hashes(self):
        test_dictionary = [
            {'from': 'word', 'to': None},
            {'from': 'word2', 'to': None},
            {'from': 'file.txt|abcdef123456', 'to': ''},
            {'from': 'image.jpg|sha256hash', 'to': ''},
            {'from': 'invalid.file|invalidhash', 'to': ''},
            {'from': 'invalidfile.txt|invalidhash', 'to': ''},
            {'from': 'validfile.txt|invalidhash', 'to': ''},
            {'from': 'file.txt', 'to': ''},
            {'from': 'invalid/file.txt', 'to': ''},
            {'from': 'image.jpg', 'to': ''},
            {'from': 'file.123', 'to': ''},
            {'from': '123:ABCabc/123+abc:XYZxyz/456+xyz', 'to': ''},
            {'from': '12:34:56', 'to': ''},
            {'from': 'invalid_ssdeep', 'to': ''},
            {'from': 'abcdef123456', 'to': ''},
            {'from': 'sha256hash', 'to': ''},
            {'from': 'invalidhash', 'to': ''},
            {'from': 'abc', 'to': ''}
        ]

...
class IPTestcase(unittest.TestCase):
    def test_validate_ipv4(self: Self):
    ...
    def test_validate_ipv6(self: Self):
        testcases = [
    ...
    def test_validate_ipv4_port(self: Self):
    ...
    def test_validate_ipv6_port(self: Self):
        testcases = [
    ...
    def test_validate_ipv4_cidr(self: Self):
    ...
    def test_validate_ipv6_cidr(self: Self):

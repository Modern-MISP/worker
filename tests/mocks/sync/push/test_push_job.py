...
def __push_sightings(sharing_groups: list[ViewUpdateSharingGroupLegacyResponse], remote_server: MispServer) -> int:
    """
...
def __server_in_sg(sharing_group: ViewUpdateSharingGroupLegacyResponse, server: MispServer) -> bool:
    """

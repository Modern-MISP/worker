    ...
    def get_event(self: Self, event_id: int, server: Server = None) -> AddEditGetEventDetails:
        tags: list[tuple[TagViewResponse, EventTagRelationship]] = [
            (
                ...
                EventTagRelationship(id=1, event_id=1, tag_id=1, local=None, relationship=None),
            )
        ]
        ...
        attribute: AttributeWithTagRelationship = AttributeWithTagRelationship(
            ...
            tags=[
                (
                    ...
                    AttributeTagRelationship(id=10, attribute_id=1, tag_id=2, local=0, relationship_type=None),
                )
            ],
        )
            ...
            AttributeWithTagRelationship(
                ...
                tags=[
                    (
                        ...
                        AttributeTagRelationship(id=11, attribute_id=1, tag_id=3, local=0, relationship_type=None),
                    )
                ],
            ),
        ]
                    ...
                    SharingGroupOrg=[
                        ViewUpdateSharingGroupLegacyResponseSharingGroupOrgItem(
                            ...
                            Organisation=ViewUpdateSharingGroupLegacyResponseOrganisationInfo(
                                id="1", uuid="387a5a4f3b454f7a968146926326516b", name="ZWEI", local=True
                            ),
                        )
                    ],
                    SharingGroupServer=[
